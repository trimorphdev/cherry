...
use ccherry_lexer::{
    Comment, CommentKind, Float, Group, Iden, Int, IntKind, Lexer, Spacing, TokenTree,
};
...
fn code_block_group() {
    ...
    assert_eq!(
        ...
        Some(Ok(TokenTree::Group(Group {
            loc: 0..8,
            tokens: vec![TokenTree::Iden(Iden {
                loc: 2..6,
